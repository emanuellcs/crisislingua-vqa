...
class JSONLExporter:
    ...
    def __init__(self, output_file: str = "../../data/processed/crisislingua_vqa_final.jsonl"):
    ...
    def export_stream(self, record_stream: Generator[Dict[str, Any], None, None], append: bool = False):
        """
        ...
        logger.info(f"Final export complete. {total_exported} records written to {self.output_file}")
